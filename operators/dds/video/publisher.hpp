 ...
 */
class DDSVideoPublisherOp : public Operator {
 public:
  HOLOSCAN_OPERATOR_FORWARD_ARGS(DDSVideoPublisherOp)
 ...
 private:
  ...
  std::shared_ptr<holoscan::dds::VideoStream::Publisher> publisher_;
};
