...
class NIMOperator(Operator):
    ...
    def compute(self, op_input, op_output, context):
        ...
        op_output.emit(seg_filename, "volume_file")
...
class NimImaging(Application):
    ...
    def compose(self):
        ...
        self.add_flow(nim_op, mask_volume_loader, {("volume_file", "file_name")})
        self.add_flow(
            nifti_volume_loader,
            volume_renderer,
            {
...
def _download_dataset(api_key):
    ...
    response.raise_for_status()
    nifti_filename = os.path.abspath("sample.nii")
    ...
    if (
        ...
        != "5c95ca6b4193745e872042edd2a2bc36"
    ):
        raise ValueError("Downloaded file is not a valid NIFTI file.")
